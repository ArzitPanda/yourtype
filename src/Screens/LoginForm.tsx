          ...
          <CardContent className="space-y-8 px-0">
            ...
            <div className="relative my-8">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <span className="bg-slate-900 px-4 text-xs text-slate-500 font-medium uppercase tracking-wider">
            ...
            <div className="space-y-6">
              <div className="space-y-5">
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-500 h-4 w-4 transition-colors group-focus-within:text-purple-400" />
                    <Input
                      id="email"
                      type="email"
                      ...
                      className="pl-10 h-12 bg-slate-800/50 border border-slate-700 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 placeholder-slate-500 text-white rounded-xl transition-all duration-200"
                      disabled={isLoading}
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    <Lock className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-500 h-4 w-4 transition-colors group-focus-within:text-purple-400" />
                    <Input
                      id="password"
                      ...
                      className="pl-10 pr-12 h-12 bg-slate-800/50 border border-slate-700 focus:border-purple-500 focus:ring-1 focus:ring-purple-500 placeholder-slate-500 text-white rounded-xl transition-all duration-200"
                      disabled={isLoading}
                    ...
                    <button
                      ...
                      className="absolute right-3 top-1/2 transform -translate-y-1/2 text-slate-500 hover:text-slate-300 transition-colors p-1 rounded-md"
                      disabled={isLoading}
                    >
                      {showPassword ? (
                ...
                <div className="flex items-center space-x-3">
                  <div className="relative">
                    <input
                      ...
                      className="h-4 w-4 rounded border-slate-600 bg-slate-800 text-purple-500 focus:ring-purple-500 focus:ring-offset-0 focus:ring-1"
                      disabled={isLoading}
                    />
                  </div>
                  <Label
              ...
              <Button 
                ...
                className="w-full h-12 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white font-medium transition-all duration-200 shadow-lg hover:shadow-xl rounded-xl border-0 relative overflow-hidden"
                disabled={isLoading}
              >
            ...
            <div className="text-center pt-6">
              ...
              <button
                ...
                onClick={() => {
                  setError('');
                  setSuccess('Creating your account will unlock personalized lessons and progress tracking.');
                }}
              >
            ...
            <div className="mt-8 p-4 bg-slate-800/30 border border-slate-700/50 rounded-lg">
              ...
              <p className="text-xs text-slate-500 text-center">
                Email: <span className="text-purple-400 font-mono">demo@example.com</span>
              </p>
              <p className="text-xs text-slate-500 text-center">
                Password: <span className="text-purple-400 font-mono">password</span>
              </p>
            </div>
          </CardContent>
        </div>
